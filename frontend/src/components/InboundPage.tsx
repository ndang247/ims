  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div className='d-flex flex-column border rounded p-2'>
        ...
        <span className='pb-2' style={{color: 'grey'}}>Incoming parcels with tag will be registered under this barcode</span>
        <span>{currentBarcode}</span>
        <span>{currentBarcodeData.title ?? ''}</span>
      </div>
      <h5 className='mt-2'>
        Barcode Inbound Registeration
        <Tooltip title="As a pallet of one product going through, after attaching NFC tag to each parcel, 
